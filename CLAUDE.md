...
| `component-gaps.md` | Before building a new screen. A running list of things built inline during a screen build, one line each; a second entry for the same thing means promote it to a real component. |
